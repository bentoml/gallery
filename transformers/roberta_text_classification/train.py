...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='BentoML Transformers Roberta Text Classification Example')
    ...
    parser.add_argument('--model-name', type=str, default="roberta_text_classification",
